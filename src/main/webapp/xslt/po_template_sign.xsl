							...
							<fo:table-row>
								...
								<fo:table-cell border-style="solid" border-color="black"
									...
									<fo:block line-height="12pt" font-size="10pt"
										space-before.optimum="1.5pt" space-after.optimum="1.5pt"
										keep-together="always" text-align="center">
										<fo:external-graphic content-height="25%" content-width="35%"
										scaling="uniform"

										src="servlet-context:/SIPL-PO-Filtered_files/signature.jpeg" />
									</fo:block>

									<fo:block line-height="12pt" font-size="10pt"
										space-before.optimum="20.5pt" space-after.optimum="1.5pt"
