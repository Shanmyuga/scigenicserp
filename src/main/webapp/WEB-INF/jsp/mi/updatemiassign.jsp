...
<c:if test="${row.tempestCost == 0}">
<display:column sortable="true"  title="PO MAt Assign"  >

<form:input path="matList[${row_rowNum%10}].poMatAssign" />
...
<input type="button"  value="Uncheck All " onclick="checkAll('miindex',false)"/>
 <input type="button"  value="Update MI Assign " onclick="eventdirect('updateAssignMI')"/>
