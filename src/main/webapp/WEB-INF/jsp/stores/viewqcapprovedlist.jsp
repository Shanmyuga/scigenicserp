...
<br>
<p style="padding-left:20px" align="center"><font color="#0080ff" size="4" face="Baskerville Old Face"> Qc approved  Items </font></p>
...
<td><form:input path="seqmiid"  id="seqmiid"/>
 ...
 <td colspan="2" align="right"><input type="button" value="Search Approved Items" onclick="eventdirect('searchRecd')"/></td>
...
<display:table export="true" sort="list"   pagesize="10" name="qcapprovedlist"  id="row"  requestURI="springtest.htm"  cellpadding="5px" cellspacing="3px" >
...
<display:column sortable="true"  title="Approved Dimension" property="qcAppDime" >

</display:column>


<display:column sortable="true"  title="Approved Quantity" property="qcAppCnt" >
...
<fmt:parseNumber var="approvedQuantity" type="NUMBER" value="${row.qcAppCnt}"></fmt:parseNumber>
<c:out value="${ut*approvedQuantity}"/>
</display:column>
</display:table>
