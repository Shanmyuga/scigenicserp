...
public class DeliveryChallanPDFServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String dtjson = (String) request.getSession(false)
                    .getAttribute("dtstring");
            DeliveryChallanDTO dto = new Gson().fromJson(dtjson,DeliveryChallanDTO.class);
           ...
           // FileInputStream fis = new FileInputStream();   //obtaining bytes from the file
            //creating Workbook instance that refers to .xlsx file
            XSSFWorkbook wb = new XSSFWorkbook(this.getClass().getClassLoader().getResourceAsStream("deliverychallan.xlsx"));
            ...
            for(String key:props.stringPropertyNames()) {
                ...
                switch (key) {
                    case "DC_NO":
                        sheet.getRow(rownum).getCell(colnum).setCellValue(Double.parseDouble(dto.getPurchaseNo()));
                        break;
                    case "DC_DATE":
