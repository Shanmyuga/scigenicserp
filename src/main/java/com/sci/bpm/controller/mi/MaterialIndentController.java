...
public class MaterialIndentController extends SciBaseController {
    ...
    public Event searchMI(RequestContext context) throws Exception {
        ...
        context.getFlowScope().put("ProposalMI",
                getLookupservice().loadIDData("MI_IN_STOCK"));
    ...
    public Event updateRawMi(RequestContext context) throws Exception {
        ...
        for (MatCollectionCommand mcoll : matslist) {
            ...
            for (String raw : rawmi) {
                purchaseItemService.deleteRawMI(master.getSeqMiId(),mcoll.getRawSeqVendorId(),Long.parseLong(raw),mcoll.getStageDesc());
                ...
                if (mi == null) {
                    ...
                    rawMIDetails.setStageDesc(mcoll.getStageDesc());
